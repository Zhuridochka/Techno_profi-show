(() => {
    ...
    function initSliders() {
        if (document.querySelector(".clients-page__slider")) new swiper_core_Swiper(".clients-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            speed: 800,
            navigation: {
                prevEl: ".section-top__button-prev",
                nextEl: ".section-top__button-next"
            },
            on: {}
        });
        ...
        if (document.querySelector(".others-section__slider")) new swiper_core_Swiper(".others-section__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                nextEl: ".others-section__button-next"
            },
            breakpoints: {
                319: {
                    slidesPerView: 1.1,
        ...
        if (document.querySelector(".recommended-section__slider")) new swiper_core_Swiper(".recommended-section__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            loop: true,
            navigation: {
                nextEl: ".recommended-section__button-next"
            },
            on: {}
        });
    }
    ...
    function windowLoaded() {
        let documentActions = e => {
            ...
            if (targetElement.closest(".contacts-header__body")) {
                if (targetElement !== "A") {
                    const contactsHeader = targetElement.closest(".contacts-header__body");
                    contactsHeader.classList.toggle("_active");
                }
            } else if (!targetElement.closest(".contacts-header__body")) {
                const contactsHeader = document.querySelector(".contacts-header__body");
                contactsHeader.classList.remove("_active");
            }
            //! Додавання класу в html
                        if (targetElement.closest(".search-main-header__search-icon")) document.documentElement.classList.toggle("search-open"); else if (!targetElement.closest(".search-main-header__body")) document.documentElement.classList.remove("search-open");
        };
        function updateHeightMarginProposotion() {
            const proposotionBody = document.querySelector(".proposotion-page__body");
            if (!proposotionBody) return;
            const proposotionHeight = proposotionBody.offsetHeight;
            const halfProposotionHeight = proposotionHeight / 3;
            document.documentElement.style.setProperty("--margin-top", `${-halfProposotionHeight}px`);
        }
        updateHeightMarginProposotion();
